# If onboarding at the Organization leve, create a new project for integration resources
...
# Create a service account in the specified (or newly created) project
